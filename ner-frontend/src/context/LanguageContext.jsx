...
const UI_STRINGS = {
  ...
  landing_forecast_label: { en: 'NORTHEAST INDIA / 3D FORECAST SURFACE', hi: 'पूर्वोत्तर भारत / 3D पूर्वानुमान सतह', as: 'উত্তৰ-পূৰ্ব ভাৰত / 3D পূৰ্বানুমান পৃষ্ঠ' },
  landing_forecast_model: { en: 'TERRAIN + WEATHER + ROAD RISK', hi: 'भू-भाग + मौसम + सड़क जोखिम', as: 'ভূখণ্ড + বতৰ + পথৰ বিপদ' },
  landing_forecast_now: { en: 'Current terrain', hi: 'वर्तमान भू-भाग', as: 'বৰ্তমান ভূখণ্ড' },
  landing_forecast_six: { en: 'Rain watch', hi: 'वर्षा निगरानी', as: 'বৰষুণ নিৰীক্ষণ' },
  landing_forecast_twelve: { en: 'Slope risk', hi: 'ढलान जोखिम', as: 'ঢালৰ বিপদ' },
  landing_forecast_day: { en: 'Route outlook', hi: 'मार्ग पूर्वानुमान', as: 'পথৰ পূৰ্বানুমান' },
  ...
  login_visual_title: { en: 'Know the route. Read the risk. Keep moving.', hi: 'मार्ग जानें। जोखिम समझें। आगे बढ़ते रहें।', as: 'পথ জানক। বিপদ বুজক। আগবাঢ়ি যাওক।' },
  login_visual_desc: { en: 'A field-first logistics network that turns terrain, weather, road conditions, and reports into one clear operating picture.', hi: 'एक फील्ड-प्रथम लॉजिस्टिक्स नेटवर्क जो भू-भाग, मौसम, सड़क की स्थिति और रिपोर्ट को एक स्पष्ट परिचालन तस्वीर में बदलता है।', as: 'ভূখণ্ড, বতৰ, পথৰ অৱস্থা আৰু প্ৰতিবেদনক এটা স্পষ্ট পৰিচালনামূলক ছবিলৈ ৰূপান্তৰ কৰা ক্ষেত্ৰ-প্ৰথম লজিষ্টিক নেটৱৰ্ক।' },
  login_live_status: { en: 'network connected', hi: 'नेटवर्क जुड़ा हुआ', as: 'নেটৱৰ্ক সংযুক্ত' },
  login_risk_status: { en: 'corridor conditions stable', hi: 'कॉरिडोर की स्थिति स्थिर', as: 'কৰিডৰৰ অৱস্থা স্থিৰ' },
  login_field_status: { en: 'ground reports monitored', hi: 'ग्राउंड रिपोर्ट की निगरानी', as: 'মাটিৰ প্ৰতিবেদন নিৰীক্ষণ' },
