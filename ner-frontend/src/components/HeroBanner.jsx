  ...
  return (
    <div className="hero-banner">
      ...
      <svg className="hero-svg" viewBox="0 0 320 120" preserveAspectRatio="xMidYMax slice">
        ...
        <path className="hero-cloud hero-cloud-a" d="M30 24 a10 10 0 1 1 0.1 0 Z M22 28 a7 7 0 1 1 0.1 0 Z M40 28 a7 7 0 1 1 0.1 0 Z" fill="#334155" opacity="0.6" />
        <path className="hero-cloud hero-cloud-b" d="M210 16 a8 8 0 1 1 0.1 0 Z M203 19 a6 6 0 1 1 0.1 0 Z M219 19 a6 6 0 1 1 0.1 0 Z" fill="#334155" opacity="0.5" />
        ...
        <g className="hero-truck">
          ...
          <circle cx="8" cy="0" r="4.5" fill="#1e293b" stroke="#0f172a" strokeWidth="1.5" />
          <circle cx="30" cy="0" r="4.5" fill="#1e293b" stroke="#0f172a" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
